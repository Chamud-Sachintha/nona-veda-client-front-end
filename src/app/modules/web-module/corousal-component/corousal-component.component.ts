...
export class CorousalComponentComponent implements OnInit,OnDestroy {
    ...
    blogPosts: BlogPost[] = [
        ...
        },
        {
            id: 5,
            title: 'Digestion',
            description: 'Vous avez souvent faim à des moments irréguliers de la journée (ou de la nuit) et avez des appétits fluctuants. Il est important de manger à des heures régulières pour éviter les problèmes de digestion comme la constipation. Manger régulièrement de petits repas (jusqu\'à cinq fois par jour) est un bon moyen d’éviter ces problèmes.',
